# conditional-calendar-complement-short-only-20260815
...
- Development route variants: `548`.
- Development-risk-eligible controls: `6615`.
...
No conditional complement selected without 2026 parameters reached +15% in all seven complete months under both cost models.
Partial `2026-08` is excluded from strict counts.

## Development Selected

`conditional-calendar-bottom_3-hit-years2-long_short-top1-weight0.10-lev4-loss0.20-profit0.16`; baseline/complement `90%/10%`; leverage `4.00x`; locks `20%/16%`.
