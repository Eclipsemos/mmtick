...
Mastermind 旗下短线策略产品。当前版本把“小果量化 ATR 收盘确认 Pine v6”并行运行在两个独立模拟账户上，实时记录 Binance SOXLB Spot 与 SOXL TradFi Perpetual 的行情、信号、成交和绩效。
...
ATR Multiplier = 1.0
仅做多，100% 账户权益
收盘价确认上穿 ATR 线后买入，确认下穿后平仓
当前 K 线收盘生成信号，下一根 K 线首笔行情成交
```
